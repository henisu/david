...
class CheeseburgerMenuService {
   ...
   */
  public function __construct(EntityTypeManagerInterface $entity_type_manager, MenuLinkTreeInterface $menu_link_tree, MenuActiveTrailInterface $menu_active_trail, CurrentRouteMatch $current_route_match, LanguageManagerInterface $language_manager) {
  ...
  public function buildMenu(array $menu_settings, $parent_menu_as_link = FALSE) {
    ...
    $tree = $this->menuLinkTree->load($menu_settings['id'], $menu_tree_parameters);
    $manipulators = [
      [
